...
func init() {
	...
	// groupDescSkipCodexDefaultInstructions is the schema descriptor for skip_codex_default_instructions field.
	groupDescSkipCodexDefaultInstructions := groupFields[50].Descriptor()
	// group.DefaultSkipCodexDefaultInstructions holds the default value on creation for the skip_codex_default_instructions field.
	group.DefaultSkipCodexDefaultInstructions = groupDescSkipCodexDefaultInstructions.Default.(bool)
