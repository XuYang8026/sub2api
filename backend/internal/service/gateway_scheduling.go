...
func (s *GatewayService) listSchedulableAccounts(ctx context.Context, groupID *int64, platform string, hasForcePlatform bool) ([]Account, bool, error) {
	...
	if useMixed {
		...
		filtered = applySchedulerAccountFilters(ctx, filtered, groupID, platform) // <fork:scheduler-hook>
	...
	accounts = applySchedulerAccountFilters(ctx, accounts, groupID, platform) // <fork:scheduler-hook>
