...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	forkOAuthSessionMirrorRegistration := repository.ProvideForkOAuthSessionMirrors(redisClient)
	proxyCircuitBreaker := service.ProvideProxyCircuitBreakerAndRegister(accountRepository, proxyRepository, proxyHealthRepository, tempUnschedCache, openAIGatewayService, forkModelsListRegistration, forkOAuthSessionMirrorRegistration)
